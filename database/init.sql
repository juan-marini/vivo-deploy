-- Initialization script for Vivo Knowledge Database
-- This script creates the database structure and initial data

CREATE DATABASE IF NOT EXISTS vivo_knowledge_db;
USE vivo_knowledge_db;
...
-- Usando BCrypt hash para senha "admin123"
